...
while(True): 
    ...
    resized_cropped_image = cv2.resize(cropped_image, (96, 96))

    input_image = np.reshape(resized_cropped_image, (1, 96, 96, 3))
    ...
    cv2.imwrite('saved_image.jpg', resized_cropped_image)
